...
public class InstanceFieldSetNode extends Node {
    ...
    public InstanceFieldSetNode(ExecutionContext context, Supplier<OutputResult> toInvoke, String fieldName, Class<?> instanceClass) {
        super(context);
    ...
    public OutputResult execute() throws ExecuteException {
        ...
        try {
            field.set(instance == null ? null : instance.object, valueObject.object);
            if (!Modifier.isPublic(field.getModifiers()) && !context.isPubliconly()) {
